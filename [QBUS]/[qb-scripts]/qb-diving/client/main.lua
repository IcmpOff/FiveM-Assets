...
AddEventHandler("QBCore:Client:OnPlayerLoaded", function()
    QBCore.Functions.TriggerCallback('QBCore-diving:server:GetBusyDocks', function(Docks)
...
RegisterNetEvent('QBCore-diving:client:UseJerrycan')
AddEventHandler('QBCore-diving:client:UseJerrycan', function()
    ...
    if boat then
        ...
        QBCore.Functions.Progressbar("reful_boat", "Refueling boat..", 20000, false, true, {
            ...
            TriggerServerEvent('QBCore-diving:server:RemoveItem', 'jerry_can', 1)
