...
RegisterNetEvent('QBCore-diving:client:NewLocations')
AddEventHandler('QBCore-diving:client:NewLocations', function()
    QBCore.Functions.TriggerCallback('QBCore-diving:server:GetDivingConfig', function(Config, Area)
        QBCoreDiving.Locations = Config
        TriggerEvent('QBCore-diving:client:SetDivingLocation', Area)
    end)
end)

RegisterNetEvent('QBCore-diving:client:SetDivingLocation')
AddEventHandler('QBCore-diving:client:SetDivingLocation', function(DivingLocation)
...
function TakeCoral(coral)
    ...
    TriggerServerEvent('QBCore-diving:server:TakeCoral', CurrentDivingLocation.Area, coral, true)
end

RegisterNetEvent('QBCore-diving:client:UpdateCoral')
AddEventHandler('QBCore-diving:client:UpdateCoral', function(Area, Coral, Bool)
...
function CallCops()
    ...
    if Call == Chance then
        TriggerServerEvent('QBCore-diving:server:CallCops', Coords)
    end
end

RegisterNetEvent('QBCore-diving:server:CallCops')
AddEventHandler('QBCore-diving:server:CallCops', function(Coords, msg)
...
RegisterNetEvent('QBCore-diving:client:UseGear')
AddEventHandler('QBCore-diving:client:UseGear', function(bool)
    if bool then
        GearAnim()
        QBCore.Functions.Progressbar("equip_gear", "Putting on wet suit..", 5000, false, true, {}, {}, {}, {}, function() -- Done
            ...
            TriggerServerEvent('QBCore-diving:server:RemoveGear')
        ...
        if currentGear.enabled then
            ...
            QBCore.Functions.Progressbar("remove_gear", "Removing wet suit..", 5000, false, true, {}, {}, {}, {}, function() -- Done
                ...
                TriggerServerEvent('QBCore-diving:server:GiveBackGear')
                ClearPedTasks(GetPlayerPed(-1))
