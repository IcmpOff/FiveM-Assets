...
AddEventHandler("consumables:client:UseJoint", function()
    QBCore.Functions.Progressbar("smoke_joint", "Lighting joint..", 1500, false, true, {
		...
		TriggerServerEvent('cosmo_hud:Server:RelieveStress', math.random(14, 18))
...
AddEventHandler("consumables:client:Oxy", function()
    ...
    QBCore.Functions.Progressbar("drink_something", "Down the pills..", 2500, false, true, {
		...
		TriggerServerEvent('cosmo_hud:Server:RelieveStress', math.random(4, 8))
...
AddEventHandler("consumables:client:Eat", function(itemName)
    ...
    QBCore.Functions.Progressbar("eat_something", "Eating..", 5000, false, true, {
        ...
        TriggerServerEvent('cosmo-hud:Server:RelieveStress', math.random(2, 4))
    end)
end)
