...
Config.Locations = {
   ["duty"] = {
       [1] = {x = 443.03, y = -983.16, z = 30.69, h = 90.654},
   },    
   ["vehicle"] = {
   ...
   ["stash"] = {
       [1] = {x = 486.97, y = -995.73, z = 30.69, h = 90.654},
   },     
   ["impound"] = {
       [1] = {x = 457.83, y = -996.42, z = 25.7, h = 180.0},
   }, 
   ["helicopter"] = {
   ...
   ["armory"] = {
       [1] = {x = 482.36, y = -995.89, z = 30.69, h = 90.654},
   },   
   ["trash"] = {
       [1] = {x = 474.28, y = -988.31, z = 26.27, h = 299.5},
   },      
   ["fingerprint"] = {
       [1] = {x = 473.1, y = -1007.57, z = 26.27, h = 358.5},
   },
   ["evidence"] = {
       [1] = {x = 474.3, y = -990.99, z = 26.27, h = 358.5},
   },
   
   ["evidence2"] = {
       [1] = {x = 579.3, y = -990.99, z = 26.27, h = 358.5},
   }, 
   
   ["evidence3"] = {
       [1] = {x = 578.3, y = -990.99, z = 26.27, h = 358.5},
   }, 
   ["stations"] = {
...
Config.Vehicles = {
    ...
    ["fbi"] = "Police Car 2",
	["police"] = "Police Car 3",
    ["police2"] = "Police Car 4",
    ["police3"] = "Police Car 5",
    ["police4"] = "Police Car 6",
    ["pranger"] = "Police Car 7",
	["pd2"] = "Police Car 8",
	["pd4"] = "Police Car 9",
	["pd5"] = "Police Car 10",
	["pd8"] = "Police Car 11",
